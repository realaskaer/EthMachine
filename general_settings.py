"""
----------------------------------------------AMOUNT CONTROL------------------------------------------------------------
    Здесь вы определяете количество или % токенов для обменов, врапов и трансферов
...
"""
AMOUNT_PERCENT = (10, 20)  # Применяется для обменов.
WRAP_AMOUNT = (0.0001, 0.0002)  # Применяется для врапов
...
PRICE_IMPACT = 5                # 0.54321 = 0.54321%, 1 = 1% | Максимальное влияние на цену при обменах токенов
